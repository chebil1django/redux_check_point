...
const TodoList = () => {
  ...
  return (
    <>
      {isOpenModal && <Modal />}
      {/* background */}
      <div className="min-h-screen bg-gradient-to-r from-red-300 via-blue-500 to-purple-600 dark:from-gray-700 dark:via-gray-900 dark:to-black pt-16 sm:pt-24 font-nunito">
